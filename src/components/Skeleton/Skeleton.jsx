...
export function SkeletonCustom({className}) {
   return (
      <Card className='mt-6  animate-pulse overflow-hidden'>
         <CardHeader
            shadow={false}
            className={`relative grid  ${className} place-items-center overflow-hidden bg-gray-300`}
         >
            <svg
